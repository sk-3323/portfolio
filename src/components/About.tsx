        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass rounded-2xl p-8 md:p-12 mb-12 animate-fade-in">
            <p className="text-lg text-foreground/90 leading-relaxed mb-6">
              ...
              , specializing in building modern web applications with the MERN
              stack. With a strong foundation in both frontend and backend
              development, I focus on writing clean, maintainable code and
              creating seamless user experiences.
            </p>
            <p className="text-lg text-foreground/90 leading-relaxed">
              My expertise includes automation integration, real-world project
              deployment, and working with cutting-edge technologies like
              Next.js, Prisma, and AI tools. I'm passionate about turning
